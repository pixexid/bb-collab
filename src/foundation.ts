...
const schema31Prefix = SHIPPED_SCHEMA31_MIGRATION.slice(0, SHIPPED_SCHEMA31_MIGRATION.indexOf("   ALTER TABLE decision_evidence RENAME TO execution_attempts_gh624_decision_evidence;"));
