...
through contract v13/schema v10: a single SQLite store with migrations, resolver,
...
Contract v13/schema v10 requires all four cached consumers to reread the
