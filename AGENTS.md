...
through contract v7/schema v10: a single SQLite store with migrations, resolver,
...
Contract v7/schema v10 requires all four cached consumers to reread the
one-request receipt, authorized-approver registry/attestation,
mutation/export/evidence, and refusal contract or refuse contract v5/schema v9.
An adopted operator_only Decision registers approverId=orchestrator:bb-collab
with the exact six derived mutation classes, including work_item_create. Attestation has no requestInput
