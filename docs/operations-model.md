...
| Merge-bound worker | Codex harness / `codex` | `gpt-5.6-luna` | MEDIUM | Model-specific qualification bar: preferred routine implementation placement; LOW and hard-core implementation remain prohibited for Luna, and the ladder does not override this bar. |
| Merge-bound worker | Codex harness / `codex` or Claude harness / `claude-code` | `gpt-5.6-sol` or `claude-opus-5[1m]` | HIGH | Class routing preference: preferred hard-core implementation placement. |
...
| Merge-bound worker | Codex harness / `codex` | `gpt-5.6-terra` | MEDIUM only | Model-specific qualification bar: merge-bound implementation is admitted by the #105 probe and the director ruling of 2026-08-18; Terra remains unqualified for orchestration, and the ladder does not override this bar. |
