...
receipt-gated `decision_disposition` path. Doctor treated that v18 artifact as
the current rollout evidence until v20 superseded it. Missing or v17 evidence is unknown and
...
close it. ADR 0004 supersedes the current-artifact statement, not this
historical repair.
